...
#these documents will be classified into the 5 topics
topic_names = [[0, "Data Science"],[1, "Economic Geology"], [2, "Offshore Regulatory"], [3, "Oil Spill Modeling"], [4, "Volcanology"]]
...
for row in datatable:
    ...
    paperloc.append(row[4])
#%%
#clean text for word to vec processing
cleandoc = cleanupdocuments(paperdata)
lda_model5 = gensim.models.ldamodel.LdaModel.load('All_LDA_5.gensim')
...
output = []
for x, paper in enumerate(paperdata):
    #get text of paper
    #newdoc = paper
    docname = paperloc[x]
    #cleanup paper
    new_doc = cleanupdocuments([paper])
    ...
    output.append([docname,paper_topics])
 
#%% Save pie chart portions
import csv
...
#%% Put this portion back in loop if you want it to save the pngs
# =============================================================================
#     print(paper_topics)
#     topicplot = []
